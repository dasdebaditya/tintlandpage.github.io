function select_state_func() // 
{
	...
	if (typevalue == 1)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Andaman and Nicobar Islands)'>Other city (Andaman and Nicobar Islands)</option>\
		</select>";
	}
	else if (typevalue == 2)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Andhra Pradesh)'>Other city (Andhra Pradesh)</option>\
		</select>";
	}
	else if (typevalue == 3)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Arunachal Pradesh)'>Other city (Arunachal Pradesh)</option>\
		</select>";
	}
	else if (typevalue == 4)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Assam)'>Other city (Assam)</option>\
		</select>";
	}
	else if (typevalue == 5)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Bihar)'>Other city (Bihar)</option>\
		</select>";
	}
	else if (typevalue == 6)
	{
	...
	else if (typevalue == 7)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Chhattisgarh)'>Other city (Chhattisgarh)</option>\
		</select>";
	}
	else if (typevalue == 8)
	{
	...
	else if (typevalue == 9)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Goa)'>Other city (Goa)</option>\
		</select>";
	}
	else if (typevalue == 10)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Gujarat)'>Other city (Gujarat)</option>\
		</select>";
	}
	else if (typevalue == 11)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Haryana)'>Other city (Haryana)</option>\
		</select>";
	}
	else if (typevalue == 12)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Himachal Pradesh)'>Other city (Himachal Pradesh)</option>\
		</select>";
	}
	else if (typevalue == 13)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Jammu and Kashmir)'>Other city (Jammu and Kashmir)</option>\
		</select>";
	}
	else if (typevalue == 14)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Jharkhand)'>Other city (Jharkhand)</option>\
		</select>";
	}
	else if (typevalue == 15)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Karnataka)'>Other city (Karnataka)</option>\
		</select>";
	}
	else if (typevalue == 16)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Kerala)'>Other city (Kerala)</option>\
		</select>";
	}
	else if (typevalue == 17)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Madhya Pradesh)'>Other city (Madhya Pradesh)</option>\
		</select>";
	}
	else if (typevalue == 18)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Maharashtra)'>Other city (Maharashtra)</option>\
		</select>";
	}
	else if (typevalue == 19)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Manipur)'>Other city (Manipur)</option>\
		</select>";
	}
	else if (typevalue == 20)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Mehgalaya)'>Other city (Mehgalaya)</option>\
		</select>";
	}
	else if (typevalue == 21)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Mizoram)'>Other city (Mizoram)</option>\
		</select>";
	}
	else if (typevalue == 22)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Nagaland)'>Other city (Nagaland)</option>\
		</select>";
	}
	else if (typevalue == 23)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Orissa)'>Other city (Orissa)</option>\
		</select>";
	}
	...
	else if (typevalue == 25)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Punjab)'>Other city (Punjab)</option>\
		</select>";
	}
	else if (typevalue == 26)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Rajasthan)'>Other city (Rajasthan)</option>\
		</select>";
	}
	else if (typevalue == 27)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Tamil Nadu)'>Other city (Tamil Nadu)</option>\
		</select>";
	}
	else if (typevalue == 28)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Tripura)'>Other city (Tripura)</option>\
		</select>";
	}
	else if (typevalue == 29)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Uttar Pradesh)'>Other city (Uttar Pradesh)</option>\
		</select>";
	}
	else if (typevalue == 30)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Uttarakhand)'>Other city (Uttarakhand)</option>\
		</select>";
	}
	else if (typevalue == 31)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			<option value=''>Select</option>\
			<option value='24 North Paraganas'>24 North Paraganas</option>\
			<option value='24 South Paraganas'>24 South Paraganas</option>\
			...
			<option value='Other city (West Bengal)'>Other city (West Bengal)</option>\
		</select>";
	}
	else if (typevalue == 32)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Dadar and Nagar Haveli)'>Other city (Dadar and Nagar Haveli)</option>\
		</select>";
	}
	else if (typevalue == 33)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Daman and Diu)'>Other city (Daman and Diu)</option>\
		</select>";
	}
	else if (typevalue == 34)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			<option value=''>Select</option>\
			<option value='Sikkim East'>Sikkim East</option>\
			<option value='Gangtok'>Gangtok</option>\
			<option value='Ghezing'>Ghezing</option>\
			<option value='Jorethang'>Jorethang</option>\
			<option value='Legship'>Legship</option>\
			<option value='Mangan'>Mangan</option>\
			<option value='Namchi'>Namchi</option>\
			<option value='Other city (Sikkim)'>Other city (Sikkim)</option>\
		</select>";
	}
	else if (typevalue == 36)
	{
		...
		<select name='city' id='cityid' class='form-control validate[required]'>\
			...
			<option value='Other city (Telangana)'>Other city (Telangana)</option>\
		</select>";
	}
}